...
CREATE UNIQUE INDEX uq_supplier_bills_number   ON supplier_bills(facility_id, bill_number);
CREATE INDEX idx_supplier_bills_facility ON supplier_bills(facility_id);
...
-- 請求明細(source_type/source_idで二重請求防止)
...
COMMENT ON TABLE supplier_bill_lines IS '問屋精算 明細';
